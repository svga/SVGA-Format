...
public final class MovieEntity extends Message<MovieEntity, MovieEntity.Builder> {
  ...
  public MovieEntity(String version, MovieParams params, Map<String, ByteString> images, List<SpriteEntity> sprites) {
    this(version, params, images, sprites, ByteString.EMPTY);
  }

  public MovieEntity(String version, MovieParams params, Map<String, ByteString> images, List<SpriteEntity> sprites, ByteString unknownFields) {
