...
goog.exportSymbol('proto.com.opensource.svga.AudioEntity', null, global);
 ...
 * @constructor
 */
proto.com.opensource.svga.AudioEntity = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.opensource.svga.AudioEntity, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.opensource.svga.AudioEntity.displayName = 'proto.com.opensource.svga.AudioEntity';
}
 ...
 * @return {!Object}
 */
proto.com.opensource.svga.AudioEntity.prototype.toObject = function(opt_includeInstance) {
  return proto.com.opensource.svga.AudioEntity.toObject(opt_includeInstance, this);
};
...
proto.com.opensource.svga.AudioEntity.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    totaltime: jspb.Message.getFieldWithDefault(msg, 5, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.opensource.svga.AudioEntity}
 */
proto.com.opensource.svga.AudioEntity.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.opensource.svga.AudioEntity;
  return proto.com.opensource.svga.AudioEntity.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.opensource.svga.AudioEntity} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.opensource.svga.AudioEntity}
 */
proto.com.opensource.svga.AudioEntity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {string}
 */
proto.com.opensource.svga.AudioEntity.prototype.getAudiokey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {number}
 */
proto.com.opensource.svga.AudioEntity.prototype.getStartframe = function() {
 ...
 * @return {number}
 */
proto.com.opensource.svga.AudioEntity.prototype.getTotaltime = function() {
 ...
 * @const
 */
proto.com.opensource.svga.MovieEntity.repeatedFields_ = [4,5];
...
proto.com.opensource.svga.MovieEntity.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.com.opensource.svga.AudioEntity.toObject, includeInstance)
  };
...
proto.com.opensource.svga.MovieEntity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.com.opensource.svga.AudioEntity;
      reader.readMessage(value,proto.com.opensource.svga.AudioEntity.deserializeBinaryFromReader);
      msg.addAudios(value);
      break;
    default:
      reader.skipField();
...
proto.com.opensource.svga.MovieEntity.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.com.opensource.svga.AudioEntity.serializeBinaryToWriter
    );
  }
};
...
/**
 * @param {!proto.com.opensource.svga.AudioEntity=} opt_value
 * @param {number=} opt_index
 * @return {!proto.com.opensource.svga.AudioEntity}
 */
proto.com.opensource.svga.MovieEntity.prototype.addAudios = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.com.opensource.svga.AudioEntity, opt_index);
};


proto.com.opensource.svga.MovieEntity.prototype.clearAudiosList = function() {
  this.setAudiosList([]);
};
